...
export const translations = {
  en: {
    ...
    proj7: "Corporate landing page integrated with Firebase Firestore.",
    proj8: "Private B2B Fleet Management SaaS (Spring Boot, React).",
  ...
  es: {
    ...
    proj7: "Landing page corporativa integrada con Firebase Firestore.",
    proj8: "SaaS B2B privado para gestión de flotas (Spring Boot, React).",
