...
export const translations = {
  en: {
    ...
    contactMessage: "If you have an opportunity, an idea, or just want to say hi, my inbox is always open. I'll try my best to get back to you as soon as possible.",
    formName: "Name",
    formEmail: "Email",
    formMessage: "Message",
    ...
    contactErrorMsg: "There was a problem. Please check the console or try emailing me directly.",
  },
  ...
  es: {
    ...
    contactMessage: "Si tienes una oportunidad, una idea, o simplemente quieres saludar, mi bandeja de entrada siempre está abierta. Me esforzaré por responderte lo antes posible.",
    formName: "Nombre",
    formEmail: "Correo",
    formMessage: "Mensaje",
    ...
    contactErrorMsg: "Hubo un problema. Por favor revisa la consola o intenta directamente a mi correo.",
  },
} as const; 
